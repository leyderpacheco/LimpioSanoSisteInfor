...
def empleados(request):
    ...
    servicios_proximos = Servicio.objects.filter(espacio__estado='próximo', fecha__gt=datetime.now())
    ...
    servicios_asignados = Servicio.objects.filter(espacio__estado='próximo', fecha__gt=datetime.now()).values(
